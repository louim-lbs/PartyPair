...
Deux voies : laisser GitHub compiler à votre place, ou compiler en local.

---

## Depuis Windows, avec VS Code et GitHub
...
Ouvrez le projet dans **Android Studio** et lancez *Run* : l'application s'installe directement sur le téléphone branché en USB.
